  ...
  return (
    <div className="rounded-xl px-3 py-2.5" style={{ background: cfg.bg }}>
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-[12.5px] font-semibold" style={{ color: cfg.text }}>{level}</span>
      </div>
    </div>
  );
}
    ...
    <div className="space-y-3">
      ...
      <div className="bg-white border border-[#e4e9e2] rounded-2xl overflow-hidden" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
        ...
        <div className="p-4 space-y-3.5">
          ...
          <div className="grid grid-cols-2 gap-2 pt-1 border-t border-[#f0f0ee]">
            <DiffRow label="Installation" level={style.installationDifficulty} />
            <DiffRow label="Maintenance" level={style.maintenanceDifficulty} />
          </div>

          {/* Key facts */}
          <div className="space-y-2.5 pt-1 border-t border-[#f0f0ee]">
            <InfoRow label="Materials" value={style.materialPalette} />
            <InfoRow label="Path type" value={style.pathType} />
            <InfoRow label="Focal element" value={style.focalElement} />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border border-[#e4e9e2] rounded-2xl overflow-hidden" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
        <div className="px-4 py-3.5 border-b border-[#f0f0ee] flex items-center gap-2">
          ...
          <span className="text-[13px] font-semibold text-[#111827]">UK Region</span>
        </div>
        <div className="p-4 space-y-3">
          <div>
            <p className="text-[10px] font-semibold text-[#9ca3af] uppercase tracking-wide mb-0.5">Region</p>
            <p className="text-[12.5px] font-semibold text-[#111827]">{postcodeInfo.region}</p>
          </div>
          <div>
            <p className="text-[10px] font-semibold text-[#9ca3af] uppercase tracking-wide mb-0.5">Climate</p>
          ...
          <div className="bg-[#f0fdf4] border border-[#bbf7d0] rounded-xl p-3">
            <p className="text-[10px] font-semibold text-[#166534] uppercase tracking-wide mb-1">Plant suitability</p>
